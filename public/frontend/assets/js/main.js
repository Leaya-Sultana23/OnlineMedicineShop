...
jQuery(document).ready(function(){
    ...
    jQuery(document).on("click",".btnapplycoupon",function(){
        //var id = jQuery(this).val();
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                var offer = (subtotal - res.data.discount_amount);
                jQuery(".cartsubtotal").text(offer);
            ...
            success:function(res){
                ...
                $.each(res.items, function(key, item){
                    ...
                    <div class="item_image">\
                        <img src="http://127.0.0.1:8000/backend/medicine/'+item.image+'" alt="image_not_found">\
                    </div>\
                    <div class="item_content">\
                        <h4 class="item_title">'+item.name+'</h4>\
                        <span class="item_price">'+item.price+'tk</span>\
                    </div>\
                ...
                jQuery(".subtotal").text(subtotal+"tk");
                jQuery(".vat").html("$"+vat);
                jQuery(".dis").html("$"+dis);
                jQuery(".total").html(total+"tk");
