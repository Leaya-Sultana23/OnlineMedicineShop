<div class="br-header">
    ...
    <div class="br-header-right">
      <nav class="nav">
        ...
        <div class="dropdown">
          <a href="" class="nav-link pd-x-7 pos-relative" data-toggle="dropdown">
            <a href="{{ route('home')}}" class="btn btn-primary btn-sm mb-2 text-white">View Frontpage</a>
            <!-- start: if statement -->
          ...
          <div class="dropdown-menu dropdown-menu-header">
            <div class="dropdown-menu-label">
              <label>View Frontpage</label>
              <a href="{{ route('home')}}">Mark All as Read</a>
            </div><!-- d-flex -->
        ...
        <div class="dropdown">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            ...
            <img src="{{Auth::user()->image}}" class="wd-32 rounded-circle" alt="">
