            ...
            <div class="header_top">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <p class="header_hotline text-white"><i class="fas fa-envelope"></i> Email:<strong>online.bd.store@gmail.com</strong></p>
                            <p class="header_hotline text-white"><i class="fas fa-phone"></i> Call us toll free: <strong>+1888 234 5678</strong></p>
                        </div>
                    </div>
                </div>
            </div>
