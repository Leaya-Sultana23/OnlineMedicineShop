					...
					<div class="col col-lg-3 col-md-3 col-sm-12">
						<div class="brand_logo">
							<a class="brand_link" href="index.html">
								<img src="{{ asset('frontend') }}/assets/images/logo/logo.png" srcset="{{ asset('frontend') }}/assets/images/logo/logo_2x.png 2x" alt="logo_not_found">
							</a>
						</div>
					</div>
                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        <li>
                            <div class="item_image">
                                <img src="{{ asset('backend') }}/medicine/images/cart/cart_img_1.jpg" alt="image_not_found">
                            </div>
                            ...
                            <tbody>
                              ...
                              @foreach($items as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span class="price_text">{{ $item->price }} tk</span></td>
                                    <td class="text-center"><button type="button" id="remove_btn"><i class="fal fa-trash-alt"></i></button></td>
                                </tr>
                              @endforeach
                            </tbody>
                        </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col col-lg-6">
                                <ul class="btns_group ul_li_right">
                                    ...
                                    <li><a class="btn btn_dark" href="{{ route('exampleHostedCheckout') }}">Prceed To Checkout</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <button class="your-button-class btn btn-info" id="sslczPayBtn"
